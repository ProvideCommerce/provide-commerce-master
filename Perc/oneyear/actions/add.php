...
$alert = __('Your comment has been added. Thank you!');
$value = '1';
validateForm($data);
...
if (JB_EMAIL && !$data['spam']) {
    ...
    if (!preg_match($find, $from) && !preg_match($find, $alert)) {
        mail($to, $subject, $comment, $headers);
    }
}

// EDIT THE 2 LINES BELOW AS REQUIRED
$email_to = "provide@marcosebastian.com";
$email_subject = "New Anniversary Card Comment";
$email_from = $data['website'];
$message = '<html><body>';
$message .= '<h2>New comment submitted, it reads:</h2>';
$message .= $data['comment'];
$message .= "<p><a href=\"http://www.providecommerce.com/Perc/oneyear/admin/login_form.php\">Click here to visit the admin page</a></p>";
$message .= "</body></html>";
