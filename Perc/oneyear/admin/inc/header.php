...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        <title>Administration <?php _e('Dashboard'); ?></title>
    ...
    <body>
        <div id="container">
            <div id="header">
				<h1>Welcome to Provide Commerce's Anniversary Card Application</h1>
            </div>
            <div id="nav">
                ...
                <ul>
                    ...
                    <li>
                        <a id="ham_link" href="ham.php"><?php _e('Comments'); ?></a>
                    </li>
                    <li>
